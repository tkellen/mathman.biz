...
{document.write('<object id="id8" type="video/quicktime" width="300" height="185" style="height: 185px; left: 258px; position: absolute; top: 881px; width: 300px; z-index: 1; "><param name="src" value="sarahwday4_files/It%27s%20Raining%20Cookies.jpg"/><param name="target" value="myself"/><param name="href" value="../Media/It%27s%20Raining%20Cookies.m4v"/><param name="controller" value="true"/><param name="scale" value="tofit"/></object>');}
else
...
{return false;}
function onPageLoad()
{loadMozillaCSS('sarahwday4_files/sarahwday4Moz.css')
